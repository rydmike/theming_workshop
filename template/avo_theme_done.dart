...
import 'package:theming_workshop/workshop/theme/avo_scheme.dart';
import 'package:theming_workshop/workshop/theme/avo_theme_ext.dart';
import 'package:theming_workshop/workshop/theme/avo_tokens.dart';
import 'package:theming_workshop/workshop/theme/theme_settings.dart';
import 'package:theming_workshop/workshop/theme/used_theme.dart';
import 'package:theming_workshop/workshop/utils/utils.dart';
...
class AvoTheme {
  ...
  // A ThemeData function where we can build our app theme.
  static ThemeData from(ColorScheme scheme, ThemeSettings settings) {
    ...
    return ThemeData(
      ...
      // 21a) Add the app bar text style to the AppBarTheme in step 6) above.
